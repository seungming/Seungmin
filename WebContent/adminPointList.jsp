...
<head>
<meta charset="UTF-8">
<title>adminPointList.jsp</title>
		...
		<div class="container">
			...
			<main class="main-content">
				...
				<div class="content-header">
					<h1 class="content-title">포인트 변동 내역</h1>
				</div>
				...
				<div class="content-body">
					<div class="info-wrapper">
						<div class="info-header">
							...
							<div class="info-cell">유형</div>
							<div class="info-cell">변동 포인트</div>
							<div class="info-cell">잔여 포인트</div>
							<div class="info-cell">사용일</div>
							<div class="info-cell">비고</div>
						...
						<div class="info-row">
							...
							<div class="info-cell">적립</div>
							<div class="info-cell">+1,000P</div>
							<div class="info-cell">10,000P</div>
							<div class="info-cell">2025-04-03</div>
							<div class="info-cell">리뷰 작성</div>
							<div class="info-cell">
								<div class="action-buttons">
									<button type="button" class="btn detail-btn"
										onclick="location.href='adminGenReqDetail.jsp'">상세보기</button>
						...
						<div class="info-row">
							...
							<div class="info-cell">EREQ00001</div>
							<div class="info-cell">고지섭</div>
							<div class="info-cell">사용</div>
							<div class="info-cell">-3,000P</div>
							<div class="info-cell">15,000P</div>
							<div class="info-cell">2025-04-03</div>
							<div class="info-cell">긴급돌봄 결제</div>
							<div class="info-cell">
								<div class="action-buttons">
									<button type="button" class="btn detail-btn"
										onclick="location.href='adminGenReqDetail.jsp'">상세보기</button>
