...
<head>
<meta charset="UTF-8">
<title>adminParViolList.jsp</title>
	...
	<div class="container">
		...
		<main class="main-content">
			<div class="content-header">
				<h1 class="content-title">부모 위반 내역</h1>
			...
			<div class="content-body">
				<div class="info-wrapper">
					...
					<div class=info-row-viol>
						...
						<div class="info-cell">PVIO00001</div>
					...
					<div class="info-row-viol">
						...
						<div class="info-cell">PVIO00002</div>
					...
					<div class="info-row-viol">
						...
						<div class="info-cell">PVIO00003</div>
					...
					<div class="info-row-viol">
						...
						<div class="info-cell">PVIO00004</div>
					...
					<div class="info-row-viol">
						...
						<div class="info-cell">PVIO00005</div>
