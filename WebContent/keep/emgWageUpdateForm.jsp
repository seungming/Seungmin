...
<head>
<meta charset="UTF-8">
<title>emgWageUpdateForm.jsp</title>
...
<div class="wrap">
	...
	<div class="container">
		...
		<main class="main-content">
			...
			<form action="emgwageupdate.action" method="post" name="emgWageUpdate">
			<div class="content-body">
				<div class="info-wrapper">
					...
					<div class="info-row">
						...
						<input type="text" name="emgWage" id="emgWage" class="txt">
					</div>
				</div>
				...
				<div class="bottom-btn">
					...
					<button type="button" class="btn cancel-btn" onclick="<%=cp %>/wagelist.action">취소</button>
				</div>
			</div>
			</form>
		</main>
