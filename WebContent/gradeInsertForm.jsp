		...
		<div class="container">
			...
			<main class="main-content">
				<div class="content-header">
					<div class="content-title">등급 정보 등록</div>
				</div>

				<!-- form 태그  -->
				<form action="gradeinsert.action" method="post" enctype="multipart/form-data" id="gradeForm">
					...
					<div class="content-body">
						...
						<div class="left-column">
							<div class="image">
								<div class="image-preview" id="imagePreview">
									<img alt="등급 이미지 미리보기" id="previewImage" style="width: 100%; height: 100%;"/>
								</div>
							</div>
						...
						<div class="right-column">
							...
							<div class="info-row">
								...
								<div class="info-cell">
									<input type="text" name="min_range" id="min_range"
										class="info-input" placeholder="예: 5000">
								</div>
							</div>
							...
							<div class="info-row">
								...
								<div class="info-cell">
									<input type="text" name="max_range" id="max_range"
										class="info-input" placeholder="예: 10000">
								</div>
							</div>
							...
							<div class="info-row">
								...
								<div class="info-cell">
									<input type="text" name="daily_max_time" id="daily_max_time"
							...
							<div class="info-row">
								...
								<div class="info-cell">
									<input type="text" name="grade_pay" id="grade_pay"
					...
					<div class="bottom-btn">
						<button type="button" class="btn submit-btn" id="submitBtn">등록하기</button>
